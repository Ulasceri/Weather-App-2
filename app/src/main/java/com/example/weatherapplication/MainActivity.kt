...
import com.example.weatherapplication.Utilites.ApiUtilities
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setData(body:WeatherModel){
        ...
        binding.apply {
            ...
            tempFValue.text = "" + BigDecimal.valueOf(k2c(body.main.temp)).setScale(1, RoundingMode.HALF_UP) + "°C";
